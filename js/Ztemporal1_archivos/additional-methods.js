...
jQuery.validator.addMethod("onlyLetterSp2", function(value, element) {
	return this.optional(element) || /^[a-zA-ZñÑáÁéÉíÍóÓúÚüÜ\ ]+$/.test(value);
}, "Letters only please");

jQuery.validator.addMethod("CC_id", function(value, element) {
	return this.optional(element) || /^[1-9]\d{4,9}$/.test(value);
}, "Por favor ingrese un número de cédula de ciudadanía válido");

jQuery.validator.addMethod("CE_id", function(value, element) {
	return this.optional(element) || /^[a-zA-Z]*[1-9]\d{3,7}$/.test(value);
}, "Por favor ingrese un número de cédula de extranjería válido");

jQuery.validator.addMethod("TI_id", function(value, element) {
	return this.optional(element) || /^\d{2}[0-1][0-9][0-3][0-9]\-\d{5}$/.test(value);
}, "Por favor ingrese un número de tarjeta de identidad válido");

jQuery.validator.addMethod("PPN_id", function(value, element) {
	return this.optional(element) || /^\w{4,12}$/.test(value);
}, "Por favor ingrese un número de pasaporte válido");

jQuery.validator.addMethod("SSN_id", function(value, element) {
	return this.optional(element) || /^\d{3}\-?\d{2}\-?\d{4}$/.test(value);
}, "Por favor ingrese un número de seguridad social válido");

jQuery.validator.addMethod("LIC_id", function(value, element) {
	return this.optional(element) || /^\w{4,12}$/.test(value);
}, "Por favor ingrese un número de licencia de conducción válido");

jQuery.validator.addMethod("NIT_id", function(value, element) {
	return this.optional(element) || /^\w{4,12}$/.test(value);
}, "Por favor ingrese un número de NIT válido");

jQuery.validator.addMethod("TAX_id", function(value, element) {
	return this.optional(element) || /^\w{4,12}$/.test(value);
}, "Por favor ingrese un número de identificación impositiva válido");
